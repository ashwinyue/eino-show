...
// 使用本地 onexstack 包，方便扩展
replace github.com/onexstack/onexstack => ./pkg/onexstack
...
require (
	...
	github.com/cloudwego/eino-ext/components/tool/duckduckgo/v2 v2.0.0-20260115090517-94ed114d488d // indirect
