<template>
  <div class="tool-result-renderer">
    ...
    <AgentTransferDisplay
      v-else-if="displayType === 'agent_transfer'"
      :data="toolData as AgentTransferData"
    />
...
import AgentTransferDisplay from './tool-results/AgentTransferDisplay.vue';
