...
const file_apiserver_v1_post_proto_rawDesc = "" +
	"\n" +
	"\x17apiserver/v1/post.proto\x12\fapiserver.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xda\x01\n" +
	"\x04Post\x12\x16\n" +
	...
	"\x06postID\x18\x01 \x01(\tR\x06postID\"9\n" +
	"\x0fGetPostResponse\x12&\n" +
	"\x04post\x18\x01 \x01(\v2\x12.apiserver.v1.PostR\x04post\"d\n" +
	...
	"totalCount\x12(\n" +
	"\x05posts\x18\x02 \x03(\v2\x12.apiserver.v1.PostR\x05postsBAZ?github.com/ashwinyue/eino-show/pkg/api/apiserver/v1;apiserverv1b\x06proto3"
...
var file_apiserver_v1_post_proto_goTypes = []any{
	(*Post)(nil),                  // 0: apiserver.v1.Post
	(*CreatePostRequest)(nil),     // 1: apiserver.v1.CreatePostRequest
	(*CreatePostResponse)(nil),    // 2: apiserver.v1.CreatePostResponse
	(*UpdatePostRequest)(nil),     // 3: apiserver.v1.UpdatePostRequest
	(*UpdatePostResponse)(nil),    // 4: apiserver.v1.UpdatePostResponse
	(*DeletePostRequest)(nil),     // 5: apiserver.v1.DeletePostRequest
	(*DeletePostResponse)(nil),    // 6: apiserver.v1.DeletePostResponse
	(*GetPostRequest)(nil),        // 7: apiserver.v1.GetPostRequest
	(*GetPostResponse)(nil),       // 8: apiserver.v1.GetPostResponse
	(*ListPostRequest)(nil),       // 9: apiserver.v1.ListPostRequest
	(*ListPostResponse)(nil),      // 10: apiserver.v1.ListPostResponse
	(*timestamppb.Timestamp)(nil), // 11: google.protobuf.Timestamp
}
var file_apiserver_v1_post_proto_depIdxs = []int32{
	11, // 0: apiserver.v1.Post.createdAt:type_name -> google.protobuf.Timestamp
	11, // 1: apiserver.v1.Post.updatedAt:type_name -> google.protobuf.Timestamp
	0,  // 2: apiserver.v1.GetPostResponse.post:type_name -> apiserver.v1.Post
	0,  // 3: apiserver.v1.ListPostResponse.posts:type_name -> apiserver.v1.Post
